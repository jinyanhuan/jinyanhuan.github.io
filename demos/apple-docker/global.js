...
//为元素添加事件
Global.fn.addEvent = function (obj,event,fn,boolean){
  if(obj.attachEvent){
    ...
    this.addEvent = function (obj,event,fn,boolean){
      if(obj){
        obj.addEventListener(event,fn,boolean);
      }
    }
  }
  this.addEvent(obj,event,fn,boolean);
};
//为元素删除事件
